...
Current release: [AnotherScape Beta 1.0.78](https://github.com/Sandy64209/anotherscape-beta/releases/tag/beta)
...
2. Extract the complete zip to its own folder.
3. Double-click `SERVER START.bat`.
